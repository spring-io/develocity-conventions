...
public interface ConfigurableBuildScan {
	...
	/**
	 * Configure the server to which the build scan should be published.
	 * @param server the Gradle Enterprise server
	 */
	void server(String server);

	/**
	 * Returns the server to which the build scan should be published.
	 * @return the Gradle Enterprise server
	 */
	String server();
	...
	/**
	 * Configures the build scan to be published on success or failure.
	 */
	void publishAlways();
