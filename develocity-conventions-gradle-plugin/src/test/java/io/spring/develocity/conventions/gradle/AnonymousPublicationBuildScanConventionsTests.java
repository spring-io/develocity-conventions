...
class AnonymousPublicationBuildScanConventionsTests {
	...
	void buildScansAreConfiguredToUseDefaultPublicationBehaviour() {
		new AnonymousPublicationBuildScanConventions(this.processRunner).execute(
				new GradleConfigurableDevelocity(this.develocity), new GradleConfigurableBuildScan(this.buildScan));
