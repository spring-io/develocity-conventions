...
public class MavenPublishConventions {
	...
	void apply(Project project) {
		project.setGroup("io.spring.ge.conventions");
	...
	private void configurePom(Project project) {
		...
		publications.withType(MavenPublication.class).configureEach((mavenPublication) -> {
			mavenPublication.pom((pom) -> {
				...
				pom.getUrl().set("https://github.com/spring-io/gradle-enterprise-conventions");
				...
				pom.scm((scm) -> {
					scm.getUrl().set("https://github.com/spring-io/gradle-enterprise-conventions");
					scm.getConnection().set("scm:git:https://github.com/spring-io/gradle-enterprise-conventions");
				});
